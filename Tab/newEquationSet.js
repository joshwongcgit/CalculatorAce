  ...
  function newEquation(val)
  {
      ...
      $(".resultboxMiddle").append("<div contenteditable = 'true' inputmode = 'none' readonly = 'readonly' id = 'calculation "  + idValue + "' class = 'tab-pane active resultTab resultTab" + tabNumber + "'> </div>");
